        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="grid gap-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Name</label>
                    <input required type="text" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                  <div>
                    <label className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Email</label>
                    <input required type="email" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Phone</label>
                    <input type="tel" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                  <div>
                    <label className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Address</label>
                    <input type="text" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Message</label>
                  <textarea required rows={5} className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)] resize-none" />
                </div>
                <button
                  type="submit"
          ...
          >
            ...
            <div className="flex gap-4">
              <MapPin className="text-[var(--color-brand-red)] shrink-0" size={22} />
              <p className="text-sm text-white/80 leading-relaxed">
                {contactData.address}
              </p>
            </div>
            <div className="flex gap-4">
              <Phone className="text-[var(--color-brand-red)] shrink-0" size={22} />
              <p className="text-sm text-white/80">{contactData.phone}</p>
            </div>
            <div className="flex gap-4">
              <Mail className="text-[var(--color-brand-red)] shrink-0" size={22} />
