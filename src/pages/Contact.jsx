              ...
              <form name="contact" onSubmit={handleSubmit} data-netlify="true" className="grid gap-5">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input required type="text" id="contact-name" name="name" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                  <div>
                    <label htmlFor="contact-email" className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Email</label>
                    <input required type="email" id="contact-email" name="email" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                </div>
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="contact-phone" className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Phone</label>
                    <input type="tel" id="contact-phone" name="phone" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                  <div>
                    <label htmlFor="contact-address" className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Address</label>
                    <input type="text" id="contact-address" name="address" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)]" />
                  </div>
                </div>
                <div>
                  <label htmlFor="contact-message" className="block text-xs font-display font-semibold text-stone-500 mb-1.5">Message</label>
                  <textarea required rows={5} id="contact-message" name="message" className="w-full rounded-lg border border-stone-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-royal)] resize-none" />
                </div>
                <button
                  type="submit"
